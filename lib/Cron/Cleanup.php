...
class Cleanup extends TimedJob {
	...
	protected function run($argument): void {
        ...
        if ( $this->appconfig->getValueString('logcleaner', 'wtparam_logmessage', '2') === '2' ) $this->logger->info('LogCleaner background job to delete duplicates in the log file executed!');
		}
	}
}
