OC.L10N.register(
    "logcleaner",
    {
    "_Delete %n {level} entry_::_Delete %n {level} entries_" : ["Vee %n {level} inskrywing uit","Vee %n {level} inskrywings uit"],
    "Delete by error level:": "Vee uit volgens foutvlak:",
    ...
    "Delete duplicates" : "Delete duplikate verwyder",
    ...
    "_Delete %n duplicate_::_Delete %n duplicates_" : ["Delete %n duplikaat","Verwyder %n duplikate"],
    "This button will delete shown number of duplicates within the error log file" : "Hierdie knoppie sal die getoon aantal duplikate binne die foutloglêer verwyder",
    ...
    "Hint:" : "Wenk:",
    "deleted" : "geskrap",
    "Show messages by this app within the log file" : "Toon boodskappe deur hierdie app binne die loglêer",
    "yes" : "ja",
    "no" : "nee",
    ...
    "Set logging level" : "Stel logingsvlak in",
    "debug" : "foutopgawe",
    "info" : "inligting",
    "warning" : "waarskuwing",
    "error" : "fout",
...
"ERROR": "FOUT",
"FATAL": "NOODLOTIG",
"delete all entries of this app": "vee alle inskrywings van hierdie toepassing uit",
"Delete all entries of the app {name}": "Vee alle inskrywings van die toepassing {name} uit",
"Delete all entries of error level {name}": "Vee alle inskrywings van foutvlak {name} uit",
"Shall a footer be displayed with useful buttons?": "Sal 'n voetskrif met nuttige knoppies vertoon word?",
