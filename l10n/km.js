OC.L10N.register(
    ...
    "Delete by error level:": "លុប​តាម​កម្រិត​កំហុស៖",
    ...
    "Search issue of the log entry on the Internet": "ស្វែងរកបញ្ហានៃការបញ្ចូលកំណត់ហេតុនៅលើអ៊ីនធឺណិត",
    "Show filters as": "បង្ហាញតម្រងជា",
"variant 1": "វ៉ារ្យ៉ង់ 1",
"variant 2": "វ៉ារ្យ៉ង់ 2",
"Filter": "តម្រង",
"off": "បិទ",
"Filter off": "បិទតម្រង",
"DEBUG": "បំបាត់កំហុស",
...
"Delete all entries of the app {name}": "លុបធាតុទាំងអស់នៃកម្មវិធី {name}",
"Delete all entries of error level {name}": "លុបធាតុទាំងអស់នៃកម្រិតកំហុស {name}",
"Shall a footer be displayed with useful buttons?": "តើបាតកថាត្រូវបង្ហាញជាមួយប៊ូតុងមានប្រយោជន៍ទេ?",
...
"Daily Nextcloud Log Summary (%1$s to %2$s)": "សង្ខេបកំណត់ហេតុប្រចាំថ្ងៃ Nextcloud (%1$s ដល់ %2$s)",
"Weekly Nextcloud Log Summary (%1$s to %2$s)": "សង្ខេបកំណត់ហេតុប្រចាំសប្តាហ៍ Nextcloud (%1$s ដល់ %2$s)",
"Monthly Nextcloud Log Summary (%1$s to %2$s)": "សង្ខេបកំណត់ហេតុប្រចាំខែ Nextcloud (%1$s ដល់ %2$s)",
                 "if you like {name}, ⭐ rate and/or 💬 comment on {name} in the {where}": "ប្រសិនបើអ្នកចូលចិត្ត {name} ⭐អត្រា និង/ឬ 💬 មតិយោបល់លើ {name} នៅក្នុង {where}",
